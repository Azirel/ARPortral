...
namespace Lyceum.AR.Portal
{
	...
	public class PortalController : MonoBehaviour
	{
		...
		[ContextMenu(nameof(ChangeInsidePortalObjectsLayerTrue))]
		public void ChangeInsidePortalObjectsLayerTrue()
		{
			ChangeInsidePortalObjectsLayer(true);
		}

		[ContextMenu(nameof(ChangeInsidePortalObjectsLayerFalse))]
		public void ChangeInsidePortalObjectsLayerFalse()
		{
			ChangeInsidePortalObjectsLayer(false);
		}

		public void ChangeInsidePortalObjectsLayer(bool fullRender)
		{
			insidePortalObjects.ForEach(insidePortalObject =>
			{
